      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Incorrect password or email');
...
var stripe = Stripe('pk_test_51Jv6ybEdz4Gt7HwphHH21Um9GOWGFgCV5HnUlzV88hzKHhgJmTx8td5avBNkgztwi9i3tTF9rJklSkCNiRn2GPiF00j5XCrrjg');
...
var bookBtn = document.querySelector('#book-tour'); // DELEGATIONS
...
if (updateForm) {
  updateForm.addEventListener('submit', function (e) {
    e.preventDefault(); //FORMDATA PARA LEER Y ENVIAR ARCHIVOS AL SERVIDOR, TAMBIEN PARA NO ARCHIVOS

    var data = new FormData(); //CON APPEND AGREGAMOS LOS ELEMENTOS EN CLAVE/VALOR COMO UN JSON PERO AQUI
...
if (updatePassword) {
  updatePassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var currentPassword, newPassword, newPasswordConfirm, data;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return (0, _updateSetting.updateSettings)(data, 'password');
